  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 lg:px-10 py-10 lg:py-14">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        {/* Today's focus card */}
        <section className="lg:col-span-2 border border-ink bg-white p-6 lg:p-8 shadow-press-soft">
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/builder" className="inline-flex items-center gap-2 px-4 py-2 bg-ink text-paper text-sm font-medium hover:bg-ink/90 shadow-press">
              Build essay →
            </Link>
            <Link to="/timed" className="inline-flex items-center gap-2 px-4 py-2 border border-ink text-sm font-medium bg-white hover:bg-paper-dim">
              Start 12-minute paragraph
            </Link>
            <Link to="/toolkit" className="inline-flex items-center gap-2 px-4 py-2 border border-rule text-sm font-medium bg-white hover:bg-paper-dim">
        ...
        {/* Quick actions */}
        <aside className="border border-rule bg-white p-6 flex flex-col gap-4">
          <p className="label-eyebrow">Quick actions</p>
          <Link to="/builder" className="border border-rule p-4 hover:bg-paper-dim transition-colors">
          ...
          <Link to="/timed" className="border border-rule p-4 hover:bg-paper-dim transition-colors">
            <p className="font-medium text-sm">Timed practice</p>
            <p className="text-xs text-ink-muted mt-1">12 / 25 / 35 / 75 min modes.</p>
          </Link>
          <Link to="/toolkit" className="border border-rule p-4 hover:bg-paper-dim transition-colors">
